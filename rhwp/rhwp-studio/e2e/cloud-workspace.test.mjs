...
try {
  ...
  await page.waitForSelector('#agent-sidebar [data-workspace-mode="cloud"]', { visible: true, timeout: 60_000 });
  ...
  const restored = await page.evaluate(() => {
    ...
    return {
      ...
      cloudTranscriptNeverOwnedLease: leaseScopes.length > 1
        ...
        && leaseScopes.every((scope) => scope.threadId === initialLeaseScope.threadId
          && scope.documentId === initialLeaseScope.documentId),
    };
  });
