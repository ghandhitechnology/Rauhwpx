...
export const auditScenarios: readonly AuditScenario[] = [
  ...
  scene('setup-rau', 'Connection and setup', 'Rau setup', 'Inspect Rau installation, authentication, and setup guidance.', { services: 'setup', page: 'settings', destination: 'ai', surface: 'provider-setup', provider: 'rau' }),
  ...
  scene('setup-grok', 'Connection and setup', 'Grok setup', 'Inspect Grok installation, authentication, and setup guidance.', { services: 'setup', destination: 'ai', page: 'settings', surface: 'provider-setup', provider: 'grok' }),
  scene('setup-cursor', 'Connection and setup', 'Cursor setup', 'Inspect Cursor installation, authentication, and setup guidance.', { services: 'setup', page: 'settings', destination: 'ai', surface: 'provider-setup', provider: 'cursor' }),
  scene('setup-opencode', 'Connection and setup', 'OpenCode setup', 'Inspect OpenCode installation, authentication, and setup guidance.', { services: 'setup', page: 'settings', destination: 'ai', surface: 'provider-setup', provider: 'opencode' }),
  scene('setup-opencode-terminal', 'Connection and setup', 'OpenCode login terminal', 'Use Enter to step through login; cancel to use an API key.', { services: 'setup', page: 'settings', destination: 'ai', surface: 'provider-setup', provider: 'opencode', terminal: '1' }),
