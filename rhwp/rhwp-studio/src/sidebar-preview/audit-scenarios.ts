...
export const auditScenarios: readonly AuditScenario[] = [
  ...
  scene('setup-opencode-terminal', 'Connection and setup', 'OpenCode login terminal', 'Use Enter to step through login; cancel to use an API key.', { services: 'setup', page: 'settings', destination: 'connections', surface: 'provider-setup', provider: 'opencode', terminal: '1' }),
