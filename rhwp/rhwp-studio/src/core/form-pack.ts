...
export const FORM_PACK_SAVE_LINE_KO = 'HWPX만 저장';
export const FORM_PACK_SAVE_LINE_EN = 'HWPX only';
export const REFUSE_BINARY_HWP_BODY_KO = 'HWP 저장은 막아 두었습니다. 표와 배치는 그대로입니다.';
export const REFUSE_BINARY_HWP_BODY_EN = 'HWP save is blocked. Tables and layout stay.';

/** 사무실 거절 안내. 한글 제목+본문이 먼저이고, 영문은 같은 뜻의 짝이다. */
export const REFUSE_BINARY_HWP_KO = `${FORM_PACK_SAVE_LINE_KO}\n${REFUSE_BINARY_HWP_BODY_KO}`;
export const REFUSE_BINARY_HWP_EN = `${FORM_PACK_SAVE_LINE_EN}\n${REFUSE_BINARY_HWP_BODY_EN}`;
