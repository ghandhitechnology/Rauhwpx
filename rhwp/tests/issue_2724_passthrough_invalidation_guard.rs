...
const EXEMPT: &[(&str, &str, Exempt, &str)] = &[
    ...
    (
        ...
        Exempt::DelegatesTo("finish_equation_edit_by_path"),
        "중첩 셀 수식 속성 변경 후 공통 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
        "commands/object_ops/equation.rs",
        "set_equation_properties_native",
        Exempt::DelegatesTo("set_equation_properties_at_native"),
        "수식 속성 변경 래퍼 — 실제 변이·무효화는 위치 지정 구현이 수행.",
    ),
    (
        "commands/object_ops/equation.rs",
        "insert_equation_in_cell_by_path_native",
        Exempt::DelegatesTo("finish_equation_edit_by_path"),
        "중첩 셀 수식 삽입 후 공통 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
        "commands/object_ops/equation.rs",
        "delete_equation_control_in_cell_by_path_native",
        Exempt::DelegatesTo("finish_equation_edit_by_path"),
        "중첩 셀 수식 삭제 후 공통 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
        "commands/table_ops.rs",
        "insert_table_row_native",
        Exempt::DelegatesTo("insert_table_row_by_cell_path_native"),
        "행 삽입 래퍼 — 경로 지정 구현이 공통 구조 편집 마무리를 수행.",
    ),
    (
        "commands/table_ops.rs",
        "insert_table_row_by_cell_path_native",
        Exempt::DelegatesTo("finish_table_structure_edit"),
        "행 삽입 후 공통 구조 편집 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
        "commands/table_ops.rs",
        "insert_table_column_native",
        Exempt::DelegatesTo("insert_table_column_by_cell_path_native"),
        "열 삽입 래퍼 — 경로 지정 구현이 공통 구조 편집 마무리를 수행.",
    ),
    (
        "commands/table_ops.rs",
        "insert_table_column_by_cell_path_native",
        Exempt::DelegatesTo("finish_table_structure_edit"),
        "열 삽입 후 공통 구조 편집 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
        "commands/table_ops.rs",
        "delete_table_row_native",
        Exempt::DelegatesTo("delete_table_row_by_cell_path_native"),
        "행 삭제 래퍼 — 경로 지정 구현이 공통 구조 편집 마무리를 수행.",
    ),
    (
        "commands/table_ops.rs",
        "delete_table_row_by_cell_path_native",
        Exempt::DelegatesTo("finish_table_structure_edit"),
        "행 삭제 후 공통 구조 편집 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
        "commands/table_ops.rs",
        "delete_table_column_native",
        Exempt::DelegatesTo("delete_table_column_by_cell_path_native"),
        "열 삭제 래퍼 — 경로 지정 구현이 공통 구조 편집 마무리를 수행.",
    ),
    (
        "commands/table_ops.rs",
        "delete_table_column_by_cell_path_native",
        Exempt::DelegatesTo("finish_table_structure_edit"),
        "열 삭제 후 공통 구조 편집 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
        "commands/table_ops.rs",
        "merge_table_cells_native",
        Exempt::DelegatesTo("merge_table_cells_by_cell_path_native"),
        "셀 병합 래퍼 — 경로 지정 구현이 공통 구조 편집 마무리를 수행.",
    ),
    (
        "commands/table_ops.rs",
        "merge_table_cells_by_cell_path_native",
        Exempt::DelegatesTo("finish_table_structure_edit"),
        "셀 병합 후 공통 구조 편집 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
        "commands/table_ops.rs",
        "split_table_cell_native",
        Exempt::DelegatesTo("split_table_cell_by_cell_path_native"),
        "셀 분할 래퍼 — 경로 지정 구현이 공통 구조 편집 마무리를 수행.",
    ),
    (
        "commands/table_ops.rs",
        "split_table_cell_by_cell_path_native",
        Exempt::DelegatesTo("finish_table_structure_edit"),
        "셀 분할 후 공통 구조 편집 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
        "commands/table_ops.rs",
        "split_table_cell_into_native",
        Exempt::DelegatesTo("split_table_cell_into_by_cell_path_native"),
        "다중 셀 분할 래퍼 — 경로 지정 구현이 공통 구조 편집 마무리를 수행.",
    ),
    (
        "commands/table_ops.rs",
        "split_table_cell_into_by_cell_path_native",
        Exempt::DelegatesTo("finish_table_structure_edit"),
        "다중 셀 분할 후 공통 구조 편집 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
        "commands/table_ops.rs",
        "split_table_cells_in_range_native",
        Exempt::DelegatesTo("split_table_cells_in_range_by_cell_path_native"),
        "범위 셀 분할 래퍼 — 경로 지정 구현이 공통 구조 편집 마무리를 수행.",
    ),
    (
        "commands/table_ops.rs",
        "split_table_cells_in_range_by_cell_path_native",
        Exempt::DelegatesTo("finish_table_structure_edit"),
        "범위 셀 분할 후 공통 구조 편집 마무리 헬퍼가 `raw_stream` 을 비운다.",
    ),
    (
