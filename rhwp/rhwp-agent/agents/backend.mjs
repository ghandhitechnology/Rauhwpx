...
- Higher-level document writes auto-commit when the turn succeeds; a failed turn rolls back its staged changes. apply_engine_edits commits one atomic undoable batch immediately.
