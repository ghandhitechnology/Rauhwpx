...
echo "[3/6] JS 문법 검사..."
for jsfile in "$ROOT"/rhwp-shared/security/file-signature.js "$ROOT"/rhwp-shared/sw/private-network.js "$SRC"/background.js "$SRC"/content-script.js "$SRC"/options.js; do
