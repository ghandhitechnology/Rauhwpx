// Bounded, sender-scoped storage for extension document fetches. The background
// owns the fetched bytes and exposes only one small sequential chunk per
// message, avoiding a whole-file structured-clone allocation in the viewer.
