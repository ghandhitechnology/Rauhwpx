...
- **66 MCP tools** — semantic reads and writes for the common work, plus registry-generated engine batches that cover every classified mutation, so the agent is never blocked on a capability the editor has.
